import { defineComponent, shallowRef, h, resolveComponent, computed, createVNode, resolveDynamicComponent, unref, mergeProps, withCtx, renderSlot, useSSRContext } from 'vue';
import { D as parseQuery, l as hasProtocol, n as joinURL, m as isScriptProtocol, E as withTrailingSlash, F as withoutTrailingSlash } from '../nitro/nitro.mjs';
import { e as useRouter, f as encodeRoutePath, r as resolveRouteObject, n as navigateTo, g as useNuxtApp, h as useRuntimeConfig, i as nuxtLinkDefaults } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const tag = computed(() => props.to ? __nuxt_component_0 : "button");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(tag)), mergeProps({
        to: __props.to,
        type: !__props.to ? __props.type : void 0,
        class: ["inline-flex items-center justify-center gap-2 rounded-full font-semibold transition-colors duration-200 focus-visible:outline-none", [unref(sizeClasses), unref(variantClasses)]]
      }, _attrs), {
...
const __nuxt_component_3 = Object.assign(_sfc_main, { __name: "BaseButton" });

export { __nuxt_component_3 as _, __nuxt_component_0 as a };
//# sourceMappingURL=BaseButton-Cgy_bc0x.mjs.map
